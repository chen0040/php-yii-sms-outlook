...
<div data-role="page" id="target-dialog">
	<div data-role="header" data-theme="<?php echo $user->header_data_theme(); ?>">
		<h1><?php echo Yii::t('translation', 'Update a SMS Template'); ?></h1>
	</div><!-- /header -->
	
	<div data-role="content" data-theme="<?php echo $user->data_theme(); ?>">	
	<form id="target-form" method="post" action="<?php echo Yii::app()->createUrl('mailSms/updateMailSmsTemplate', array('url'=>$url, 'field_id'=>$field_id, 'parent_url'=>$parent_url, 'id'=>$model->id)); ?>" data-ajax="false">
		<table width="100%">
		<tr>
		<td colspan="3">
		<div>
			<ul data-role="listview" data-inset="true">
				...
				<li data-role="fieldcontain">
					...
					<input type="text" name="template_title" id="template_title" value="<?php echo $model->getTemplateTitle(); ?>"/>
				</li>
				
				<li data-role="fieldcontain">
					<label for="message_body"><?php echo Yii::t('translation', 'Message Body'); ?>:</label>
					<textarea cols="40" rows="40" name="message_body" id="message_body" class="mail_body"><?php echo $model->message_body; ?></textarea>
				</li>
			</ul>
		...
		<td style="text-align:center"><input type="submit" value="<?php echo Yii::t('translation', 'Delete'); ?>" id="Delete" name="Delete" data-inline="true" data-icon="delete" class="cancel-btn" /></td>
