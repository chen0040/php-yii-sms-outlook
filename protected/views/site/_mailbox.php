...
$no_columns=2;
if($field_id==SiteStateMachine::FIELD_OUTBOX || $field_id==SiteStateMachine::FIELD_DRAFT || $field_id==SiteStateMachine::FIELD_SENT || $field_id==SiteStateMachine::FIELD_TRASH || $field_id==SiteStateMachine::FIELD_CONTACTS || $field_id==SiteStateMachine::FIELD_GROUPS)
{
	$no_columns=3;
}
...
<div class="left-content">
	<ul data-role="listview" data-theme="c" data-dividertheme="<?php echo $data_divider_theme; ?>">
		...
		<a href="<?php echo Yii::app()->createUrl('site/index', array('field_id'=>SiteStateMachine::FIELD_OUTBOX)); ?>">
		...
		<a href="<?php echo Yii::app()->createUrl('site/index', array('field_id'=>SiteStateMachine::FIELD_DRAFT)); ?>">
		...
		<a href="<?php echo Yii::app()->createUrl('site/index', array('field_id'=>SiteStateMachine::FIELD_SENT)); ?>">
		...
		<a href="<?php echo Yii::app()->createUrl('site/index', array('field_id'=>SiteStateMachine::FIELD_TRASH)); ?>">
		...
		<a href="<?php echo Yii::app()->createUrl('mailSms/compose', array('url'=>'site/index', 'field_id'=>SiteStateMachine::FIELD_OUTBOX)); ?>" data-role="button" data-icon="plus" data-transition="slide"><?php echo Yii::t('translation', 'Compose'); ?></a>
		</div>
		</li>
		...
		<a href="<?php echo Yii::app()->createUrl('site/index', array('field_id'=>SiteStateMachine::FIELD_CONTACTS)); ?>">
		...
		<a href="<?php echo Yii::app()->createUrl('site/index', array('field_id'=>SiteStateMachine::FIELD_GROUPS)); ?>">
		...
		<li data-role="list-divider">
		<div data-role="controlgroup" data-mini="true" data-type="horizontal" >
		<a href="<?php echo Yii::app()->createUrl('contact/addContact', array('url'=>'site/index', 'field_id'=>SiteStateMachine::FIELD_CONTACTS)); ?>" data-role="button" data-icon="plus" data-transition="slide"><?php echo Yii::t('translation', 'Contact'); ?></a>
		<a href="<?php echo Yii::app()->createUrl('group/addGroup', array('url'=>'site/index', 'field_id'=>SiteStateMachine::FIELD_GROUPS)); ?>" data-role="button" data-icon="plus" data-transition="slide"><?php echo Yii::t('translation', 'Group'); ?></a>
		</div>
		</li>
		...
		<a href="<?php echo Yii::app()->createUrl('site/index', array('field_id'=>SiteStateMachine::FIELD_CALENDAR)); ?>">
		...
		<a href="<?php echo Yii::app()->createUrl('site/index', array('field_id'=>SiteStateMachine::FIELD_TASK)); ?>">
		<?php echo CHtml::image(Yii::app()->baseUrl.'/img/tasks.png', 'Tasks', array('class'=>'ui-li-icon')); ?> <?php echo Yii::t('translation', 'Tasks'); ?> 	<span class="ui-li-count"><?php echo $user->getTaskCount(); ?></span></a>
		</li>
		<li <?php if($state_machine->field_id==SiteStateMachine::FIELD_SETTINGS) echo 'data-theme="e"'; ?> >
		<a href="<?php echo Yii::app()->createUrl('site/index', array('field_id'=>SiteStateMachine::FIELD_SETTINGS)); ?>">
		...
		<li data-role="list-divider">
		<div data-role="controlgroup" data-mini="true" data-type="horizontal">
		<a href="<?php echo Yii::app()->createUrl('site/index'); ?>" data-role="button" data-icon="plus" data-rel="dialog" data-transition="pop"><?php echo Yii::t('translation', 'Task'); ?></a>
		<a href="<?php echo Yii::app()->createUrl('site/index'); ?>" data-role="button" data-icon="plus" data-rel="dialog" data-transition="pop"><?php echo Yii::t('translation', 'Note'); ?></a>
		</div>
		</li>
	</ul>
</div>
...
<div class="middle-content">
	...
	<ul data-role="listview" data-theme="c" data-dividertheme="<?php echo $data_divider_theme; ?>">
		...
		<?php foreach($outboxs as $key => $group_mails): ?>
			...
			<?php for($group_mail_index=0; $group_mail_index < $group_mail_count; ++$group_mail_index): ?>
					...
					<a href="#" onclick="go_to_record(<?php echo $mail->id; ?>); return false;">
	...
	<ul data-role="listview" data-theme="c" data-dividertheme="<?php echo $data_divider_theme; ?>">
		...
		<?php for($ci=0; $ci < $contact_count; $ci++): ?>						
			...
			<a href="#" onclick="go_to_record(<?php echo $contact->id; ?>); return false;">
	...
	<ul data-role="listview" data-theme="c" data-dividertheme="<?php echo $data_divider_theme; ?>">
		...
		<?php for($gi=0; $gi < $group_count; $gi++): ?>						
			<?php $group=$groups[$gi]; ?>
			
			<li <?php if($group->id==$current_group_id) echo 'data-theme="e"'; ?> >
			<a href="#" onclick="go_to_record(<?php echo $group->id; ?>); return false;">
...
<div class="right-content">
	...
	<ul data-role="listview" data-theme="c" data-dividertheme="<?php echo $data_divider_theme; ?>">
		...
		<div data-role="controlgroup" data-mini="true" data-type="horizontal">
			...
			<a href="<?php echo Yii::app()->createUrl('mailSms/deleteMailSms', array('url'=>'site/index', 'field_id'=>$state_machine->field_id, 'id'=>$current_outbox_id)); ?>" data-role="button" data-icon="delete" data-rel="dialog" data-transition="pop"><?php echo Yii::t('translation', 'Delete'); ?></a>
			<a href="<?php echo Yii::app()->createUrl('mailSms/updateMailSms', array('url'=>'site/index', 'field_id'=>$state_machine->field_id, 'id'=>$current_outbox_id)); ?>" data-role="button" data-icon="check" data-transition="slide"><?php echo Yii::t('translation', 'Action'); ?></a>
			<?php endif; ?>
		</div>
		</li>
	</ul>
	...
	<ul data-role="listview" data-theme="c" data-dividertheme="<?php echo $data_divider_theme; ?>">
		...
		<?php if(isset($current_draft)): ?>
			<a href="<?php echo Yii::app()->createUrl('mailSms/deleteMailSms', array('url'=>'site/index', 'field_id'=>$state_machine->field_id, 'id'=>$current_draft_id)); ?>" data-role="button" data-icon="delete" data-rel="dialog" data-transition="pop"><?php echo Yii::t('translation', 'Delete'); ?></a>
			<a href="<?php echo Yii::app()->createUrl('mailSms/updateMailSms', array('url'=>'site/index', 'field_id'=>$state_machine->field_id, 'id'=>$current_draft_id)); ?>" data-role="button" data-icon="check" data-transition="slide"><?php echo Yii::t('translation', 'Action'); ?></a>
		<?php endif; ?>
		</div>
		</li>
	</ul>
	...
	<ul data-role="listview" data-theme="c" data-dividertheme="<?php echo $data_divider_theme; ?>">
		...
		<?php if(isset($current_sentMail)): ?>
			<a href="<?php echo Yii::app()->createUrl('mailSms/deleteMailSms', array('url'=>'site/index', 'field_id'=>$state_machine->field_id, 'id'=>$current_sentMail_id)); ?>" data-role="button" data-icon="delete" data-rel="dialog" data-transition="pop"><?php echo Yii::t('translation', 'Delete'); ?></a>
			<a href="<?php echo Yii::app()->createUrl('mailSms/updateMailSms', array('url'=>'site/index', 'field_id'=>$state_machine->field_id, 'id'=>$current_sentMail_id)); ?>" data-role="button" data-icon="check" data-transition="slide"><?php echo Yii::t('translation', 'Action'); ?></a>
		<?php endif; ?>
		</div>
		</li>
	</ul>
	...
	<ul data-role="listview" data-theme="c" data-dividertheme="<?php echo $data_divider_theme; ?>">
		...
		<?php if(isset($current_trashMail)): ?>
			<a href="<?php echo Yii::app()->createUrl('mailSms/deleteMailSms', array('url'=>'site/index', 'field_id'=>$state_machine->field_id, 'id'=>$current_trashMail_id)); ?>" data-role="button" data-icon="delete" data-rel="dialog" data-transition="pop"><?php echo Yii::t('translation', 'Delete'); ?></a>
			<a href="<?php echo Yii::app()->createUrl('mailSms/updateMailSms', array('url'=>'site/index', 'field_id'=>$state_machine->field_id, 'id'=>$current_trashMail_id)); ?>" data-role="button" data-icon="check" data-transition="slide"><?php echo Yii::t('translation', 'Action'); ?></a>
		<?php endif; ?>
		</div>
		</li>
	</ul>
	...
	<ul data-role="listview" data-theme="c" data-dividertheme="<?php echo $data_divider_theme; ?>">
		...
		<li>
		<?php 
			$this->renderPartial('../contact/_viewContact', array('current_contact'=>$current_contact, 'state_machine'=>$state_machine)); 
		?>
		</li>
		<?php if(isset($current_contact)): ?>
		<li data-role="list-divider">
		<div data-role="controlgroup" data-mini="true" data-type="horizontal">
			<a href="<?php echo Yii::app()->createUrl('contact/deleteContact', array('id'=>$current_contact_id, 'url'=>'site/index', 'field_id'=>$state_machine->field_id)); ?>" data-role="button" data-icon="delete" data-rel="dialog" data-transition="pop"><?php echo Yii::t('translation', 'Delete'); ?></a>
			<a href="<?php echo Yii::app()->createUrl('contact/updateContact', array('id'=>$current_contact_id, 'url'=>'site/index', 'field_id'=>$state_machine->field_id)); ?>" data-role="button" data-icon="check" data-transition="slide"><?php echo Yii::t('translation', 'Update'); ?></a>
		</div>
		</li>
		<li data-role="list-divider">
		<div data-role="controlgroup" data-mini="true" data-type="horizontal">
		<a href="<?php echo Yii::app()->createUrl('contact/addContactToGroup', array('url'=>'site/index', 'field_id'=>$state_machine->field_id, 'contact_id'=>$current_contact->id)); ?>" data-role="button" data-icon="plus"><?php echo Yii::t('translation', 'Add to Group'); ?></a>
		<a href="<?php echo Yii::app()->createUrl('contact/removeContactFromGroup', array('url'=>'site/index', 'field_id'=>$state_machine->field_id, 'contact_id'=>$current_contact->id)); ?>" data-role="button" data-icon="delete"><?php echo Yii::t('translation', 'Remove From Group'); ?></a>
		</div>
		</li>
		<?php endif; ?>
	</ul>
	...
	<ul data-role="listview" data-theme="c" data-dividertheme="<?php echo $data_divider_theme; ?>">
		...
		<li>
		<?php 
			$this->renderPartial('../group/_viewGroup', array('current_group'=>$current_group, 'state_machine'=>$state_machine)); 
		?>
		</li>
		<?php if(isset($current_group)): ?>
		<li data-role="list-divider">
		<div data-role="controlgroup" data-mini="true" data-type="horizontal">
			<a href="<?php echo Yii::app()->createUrl('group/deleteGroup', array('id'=>$current_group_id, 'url'=>'site/index', 'field_id'=>$state_machine->field_id, 'group_id'=>$current_group_id)); ?>" data-role="button" data-icon="delete" data-rel="dialog" data-transition="pop"><?php echo Yii::t('translation', 'Delete'); ?></a>
			<a href="<?php echo Yii::app()->createUrl('group/updateGroup', array('id'=>$current_group_id, 'url'=>'site/index', 'field_id'=>$state_machine->field_id, 'group_id'=>$current_group_id)); ?>" data-role="button" data-icon="check" data-transition="slide"><?php echo Yii::t('translation', 'Update'); ?></a>
		</div>
		</li>
		<?php endif; ?>
	</ul>
...
function search_by_keywords()
{
	...
	request_result(field_id, sub_field_id, page_sub_field_id_max, page_sub_field_id_min, search_keywords);
}
function request_result(field_id, sub_field_id, page_sub_field_id_max, page_sub_field_id_min, search_keywords)
{
	var url = "<?php echo Yii::app()->createUrl('site/index'); ?>&field_id="+field_id+"&sub_field_id="+sub_field_id+"&page_sub_field_id_max="+page_sub_field_id_max+"&page_sub_field_id_min="+page_sub_field_id_min+"&search_keywords="+search_keywords;
